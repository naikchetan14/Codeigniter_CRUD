    ...
    <div class="modal-body container w-25 h-50 shadow-sm p-4 mt-5">
      ...
      <form action="/getloginUser" method="post">
        <div class="mb-3">
          ...
          <input type="email" class="form-control" id="email" name="email" placeholder="Enter Email..." value="<?= old('email') ?>" aria-describedby="emailHelp">
          <?php
        ...
        <div class="mb-3">
          ...
          <input type="password" class="form-control" id="password" name="password" placeholder="Enter Password..." aria-describedby="emailHelp">
          <?php
